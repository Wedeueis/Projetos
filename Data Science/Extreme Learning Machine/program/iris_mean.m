...
for rnd = 1 : 10
    ...
    iris_data;
    [learn_time, test_time, train_accuracy, test_accuracy]=elm('iris_train','iris_test',1,300);
    testELM(rnd,1)=test_accuracy;
    trainELM(rnd,1)=train_accuracy;
    train_timeELM(rnd,1)=learn_time;
    testing_timeELM(rnd,1)=test_time;
	
	[learn_time, test_time, train_accuracy, test_accuracy]=mlp('iris_train','iris_test',1,5);
