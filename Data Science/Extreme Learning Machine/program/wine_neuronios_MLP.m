function [AverageTrainingAccuracy, AverageTestingAccuracy] = wine_neuronios_MLP(numeroDeNeuronios)
test=zeros(5,1);
train=zeros(5,1);
...
for rnd = 1 : 5
    ...
    wine_data;
    [learn_time, test_time, train_accuracy, test_accuracy]=mlp('wine_train','wine_test',1,numeroDeNeuronios);
